...
try:
    sql     = "create table if not exists users(id integer primary key auto_increment, bio varchar(5000), password varchar(100) not null, name varchar(100) not null, surname varchar(100) not null, email varchar(100) unique not null);"
    ...
    sql4    = "create table if not exists text(id bigint, content varchar(1000))"
